			...
			<div class="row align-items-center text-center">
				<div class="col-md-12">
					<div class="card-body">
						...
						<button class="btn btn-block mb-4" style="background-color: #88C8BC;color: #fff;">Login</button>
						<p class="mb-2">Don't have an account? <a href="signup" class="f-w-400">Sign Up</a></p>
                    </form>
					</div>
				</div>
			</div>
